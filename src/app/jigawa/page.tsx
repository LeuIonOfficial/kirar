...
export default function JigawaProject() {
  return (
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 md:px-8 lg:px-16 max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-4xl mx-auto leading-relaxed font-light">
            Transforming degraded landscapes in Nigeria through community-driven
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <Image
                src="/images/featured-projects/jigawa-project.svg"
                alt="Jigawa reforestation project"
                width={600}
                height={400}
