...
export default function FeaturedProjects() {
  ...
  const projects = [
    {
      name: "Boreal",
      image: "/images/featured-projects/boreal-project.svg",
      href: "/boreal",
    },
    {
      name: "Jigawa",
      image: "/images/featured-projects/jigawa-project.svg",
      href: "/jigawa",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project) => (
            ...
            >
              <div className="relative h-96 lg:h-[500px] rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl">
                {/* Background Image */}
                <Image
                  src={project.image}
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-8">
                  <h3 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mb-8 transition-transform duration-500 group-hover:scale-105">
                    {project.name}
                  </h3>
