...
export default function ConnectWithUs() {
  const locations = [
    ...
    },
    {
      name: 'Africa',
      flag: '🇿🇦',
      coordinates: [22.937506, -30.559482] as [number, number],
            labelCoords: [-20, 10] as [number, number],
            labelWidth: 80
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="text-teal-500 text-sm font-medium uppercase tracking-wider">Locations</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
            Our company guides global projects and partnerships to deliver global climate impact.
          </p>
            ...
            >
              ...
              {locations.map((location, index) => (
                <Marker key={index} coordinates={location.coordinates}>
                  <g>
                    {/* Pin Point */}
                    <circle r={6} fill="#14b8a6" stroke="#fff" strokeWidth={3} />
                    {/* Pin Line */}
                    <line x1={0} y1={-6} x2={0} y2={-35} stroke="#14b8a6" strokeWidth={3} />
                    ...
                    <g transform="translate(0, -40)">
                      ...
                      >
                        <tspan x={location.labelCoords[0]} y={2} fontSize={14}>{location.flag}</tspan>
                        <tspan x={location.labelCoords[1]} fontSize={11} fontWeight={600}>{location.name}</tspan>
                      </text>
                    </g>
                  </g>
                </Marker>
